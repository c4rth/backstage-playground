...
function toTableRows(fields: any, fieldType: "element" | "input" | "output"): TableRow[] {
  if (!fields) return [];
...
export const McaComponentFieldsCard = memo<McaComponentFieldsCardProps>(({ data, fieldType, title }) => {
