...
`,
  ...
  {
    name: 'transformZonedTimestampToMCTimestampJSON',
    func: `function($value, $default) {  
  ...
  {
    name: 'transformZonedTimestampToMCTimestampOpenAPI',
    func: `function($value, $default) {  
    ($exists($value) and $value != null)  
