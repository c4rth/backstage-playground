import { McaBaseType, McaBaseTypeListFields, McaBaseTypeListResult, McaComponent, McaComponentListFields, McaComponentListResult, McaComponentType, McaVersions } from '@internal/plugin-mca-common';
