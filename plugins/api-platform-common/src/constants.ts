export const API_PLATFORM_API_NAME_ANNOTATION = "api-name";
export const API_PLATFORM_API_PROJECT_ANNOTATION = "api-project";
export const API_PLATFORM_API_VERSION_ANNOTATION = "api-version";
