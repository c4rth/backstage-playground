...
export const EntityAzureReadmeCard = azureDevOpsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./components/EntityPageAzurePipelines').then(m => m.EntityPageAzurePipelines),
    },
  }),
);
...
/** @public */
export const CustomAzurePipelinesContent = azureDevOpsPlugin.provide(
  createComponentExtension({
    name: 'CustomAzurePipelinesContent',
    component: {
      lazy: () => import('./components/EntityPageAzurePipelines').then(m => m.EntityPageAzurePipelines),
    },
  }),
...
/** @public */
export const CustomAzureGitTagsContent = azureDevOpsPlugin.provide(
  createComponentExtension({
    name: 'CustomAzureGitTagsContent',
    component: {
      lazy: () => import('./components/EntityPageAzureGitTags').then(m => m.EntityPageAzureGitTags),
    },
  }),
);
